...
fun getData(): List<ModelScratch> {
    ...
    list.add(ModelScratch("", "Spin Win", R.drawable.scratch, R.drawable.ic_spin))
    list.add(ModelScratch("", "Spin Big", R.drawable.ic_scratch_card_big_2, R.drawable.ic_spin))
